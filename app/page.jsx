          ...
          <div className="space-y-7">
            {professionals.map((professional, index) => (
              <details key={professional.name} open={index === 0} className="group rounded-[30px] border border-white/10 bg-[#0d0d0d] shadow-[0_25px_80px_rgba(0,0,0,0.45)] overflow-hidden open:border-[#d6b35f]/65">
                <summary className="grid cursor-pointer list-none lg:grid-cols-[360px_1fr_auto] gap-6 items-center p-5 lg:p-7 [&::-webkit-details-marker]:hidden">
                  <div className="h-[250px] lg:h-[210px] rounded-[24px] overflow-hidden bg-zinc-900">
                    <img src={professional.cover} alt={`Trabalho de ${professional.name}`} className="h-full w-full object-cover group-hover:scale-105 transition duration-700" />
                  </div>
                  <div>
