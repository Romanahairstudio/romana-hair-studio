export default function RomanaHairLandingPage() {
  ...
  const transformations = [
    ...
    { name: 'Mega Hair Loiro Iluminado', before: '/images/b1.webp', after: '/images/b2.webp', description: 'Resultado sofisticado com brilho e movimento.' },
          ...
          <div className="grid lg:grid-cols-[1.02fr_0.98fr] items-end gap-8">
            ...
            <div className="relative hidden lg:block min-h-[650px]">
              <img
                ...
                className="absolute right-0 bottom-10 w-[560px] h-[680px] object-cover object-top rounded-t-[48px] opacity-95 shadow-[0_0_80px_rgba(0,0,0,0.65)]"
              />
              <div className="absolute right-0 bottom-10 w-[560px] h-[680px] rounded-t-[48px] bg-gradient-to-t from-black via-transparent to-transparent" />
            </div>
          </div>
