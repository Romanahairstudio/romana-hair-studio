export default function RomanaHairLandingPage() {
  ...
  const services = [
    ...
    { title: 'Bronzeamento Artificial', text: 'Pele bronzeada com segurança, beleza e naturalidade.', icon: '☼', img: 'public/images/Glow Up_.jpg?q=80&w=700&auto=format&fit=crop' },
  ]
