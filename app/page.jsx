export default function RomanaHairLandingPage() {
  ...
  const services = [
    ...
    { title: 'Podologia', text: 'Saúde, cuidado e bem-estar para seus pés com profissionais qualificados.', icon: '♧', img: 'https://images.unsplash.com/photo-1519415510236-718bdfcd89c8?q=80&w=700&auto=format&fit=crop' },
    { title: 'Bronzeamento Artificial', text: 'Pele bronzeada com segurança, beleza e naturalidade.', icon: '☼', img: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=700&auto=format&fit=crop' },
          ...
          <div className="grid lg:grid-cols-[1.02fr_0.98fr] items-end gap-8">
            ...
            <div className="relative hidden lg:block min-h-[650px]">
              <img
                ...
                className="absolute right-0 bottom-0 w-[560px] h-[680px] object-cover object-top rounded-t-[48px] opacity-95 shadow-[0_0_80px_rgba(0,0,0,0.65)]"
              />
              <div className="absolute right-0 bottom-0 w-[560px] h-[680px] rounded-t-[48px] bg-gradient-to-t from-black via-transparent to-transparent" />
            </div>
          </div>
